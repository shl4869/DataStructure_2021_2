...
ListInfo merge_list(ListInfo listA, ListInfo listB) {
	...
	ListInfo listMerged;
	listMerged.phead = (ListNode**)malloc(sizeof(ListNode*));
	listMerged.plast = (ListNode**)malloc(sizeof(ListNode*));
	*listMerged.phead = NULL;
	*listMerged.plast = NULL;
...
void main() {
	...
	listA.phead = (ListNode**)malloc(sizeof(ListNode*));
	listA.plast = (ListNode**)malloc(sizeof(ListNode*));
	listB.phead = (ListNode**)malloc(sizeof(ListNode*));
	listB.plast = (ListNode**)malloc(sizeof(ListNode*));
